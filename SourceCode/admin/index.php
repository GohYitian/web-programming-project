...
<head>
    ...
    <meta name="admin dashboard" content="dashboard">
    <meta name="CVBS" content="admin dashboard">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Vaccination Applied</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">

                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php $result = mysqli_query($con, "SELECT * FROM vaccinationappointment ");
                                                    $num_rows = mysqli_num_rows($result); {
                                                    ?>
                                                        <h4>
                                                        <?php echo htmlentities($num_rows);
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        ...
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                            <?php $result = mysqli_query($con, "SELECT * FROM contactus ");
                                                            $num_rows = mysqli_num_rows($result); {
                                                            ?>
                                                                <h4>
                                                                <?php echo htmlentities($num_rows);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Cases</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">4.54M</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Covid-19 Cases in Malaysia</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Vaccination Analysis</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> No Vaccinated
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> 1-Dose Vaccinated
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Fully Vaccinated
                                    </div>
                                </div>
                            </div>
                        </div>
